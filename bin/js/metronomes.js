...
pixi_plugins_app_NapeApplication.prototype = $extend(pixi_plugins_app_Application.prototype,{
	...
	,initNape: function(space) {
		if(space == null) this.space = new nape_space_Space(nape_geom_Vec2.get(0,0,null)); else this.space = space;
		this.cumalativeDt = .0;
	}
...
Main.prototype = $extend(pixi_plugins_app_NapeApplication.prototype,{
	...
	,createMetronomes: function() {
		...
		this.tickListener = new nape_callbacks_InteractionListener((function($this) {
			...
			return $r;
		}(this)),Metronome.barCbType,Metronome.sensorCbType,$bind(this,this.tickSensorHandler));
		this.space.zpp_inner.wrap_listeners.add(this.tickListener);
	}
...
Metronome.prototype = {
	setup: function() {
		...
		b.setShapeMaterials(new nape_phys_Material(0.2,0.57,0.74,2.7,0.001));
		b.set_group(new nape_dynamics_InteractionGroup(false));
		((function($this) {
			var $r;
			if(b.zpp_inner_i.wrap_cbTypes == null) b.zpp_inner_i.setupcbTypes();
			$r = b.zpp_inner_i.wrap_cbTypes;
			return $r;
		}(this))).add(Metronome.barCbType);
		if((b.zpp_inner.compound == null?null:b.zpp_inner.compound.outer) != compound) {
			if((b.zpp_inner.compound == null?null:b.zpp_inner.compound.outer) != null) (b.zpp_inner.compound == null?null:b.zpp_inner.compound.outer).zpp_inner.wrap_bodies.remove(b);
			if(compound != null) compound.zpp_inner.wrap_bodies.add(b);
		}
		...
		b.setShapeMaterials(new nape_phys_Material(0,0.57,0.84,11.34,0.01));
		if((b.zpp_inner.compound == null?null:b.zpp_inner.compound.outer) != compound) {
			if((b.zpp_inner.compound == null?null:b.zpp_inner.compound.outer) != null) (b.zpp_inner.compound == null?null:b.zpp_inner.compound.outer).zpp_inner.wrap_bodies.remove(b);
			if(compound != null) compound.zpp_inner.wrap_bodies.add(b);
		}
		...
		if(b.zpp_inner.compound == null) null; else b.zpp_inner.compound.outer;
		this.tuneWeight = b;
		this.pivot = new nape_constraint_PivotJoint(this.pivotBall,this.bar,nape_geom_Vec2.get(0,0,true),nape_geom_Vec2.get(0,75.,true));
		this.pivot.set_compound(compound);
		this.pivot.set_ignore(true);
		this.pivot.set_stiff(true);
		this.pivot.set_damping(0);
		this.massWeld = new nape_constraint_WeldJoint(this.massBall,this.bar,nape_geom_Vec2.get(0,0,true),nape_geom_Vec2.get(0,150.,true));
		this.massWeld.set_compound(compound);
		this.massWeld.set_ignore(true);
		this.massWeld.set_stiff(true);
		this.massWeld.set_damping(0);
		this.tuneWeld = new nape_constraint_WeldJoint(this.tuneWeight,this.bar,nape_geom_Vec2.get(0,0,true),nape_geom_Vec2.get(0,0,true));
		this.tuneWeld.set_compound(compound);
		...
		tickSensorShape.zpp_inner.sensorEnabled;
		this.tickSensor = new nape_phys_Body((function($this) {
			var $r;
			if(zpp_$nape_util_ZPP_$Flags.BodyType_KINEMATIC == null) {
				zpp_$nape_util_ZPP_$Flags.internal = true;
				zpp_$nape_util_ZPP_$Flags.BodyType_KINEMATIC = new nape_phys_BodyType();
		...
		this.tickSensor.get_cbTypes().add(Metronome.sensorCbType);
		this.tickSensor.get_userData().metronome = this;
		compound.set_space(this.space);
		this.set_x(this._x);
		this.set_y(this._y);
	...
	,set_x: function(value) {
		return this.tickSensor.get_position().set_x(this.pivotBall.get_position().set_x(this._x = value));
	}
	,set_y: function(value) {
		this.tickSensor.get_position().set_y(value - 150.);
		return this.pivotBall.get_position().set_y(this._y = value);
	}
	,setTuneAnchorPosition: function(value) {
		if(value != this.tuneAnchorPosition) {
			var max = -150.;
			var min = this.pivot.get_anchor2().get_y() - 8. - 16;
			this.tuneWeld.get_anchor2().set_y(min + value * (max - min));
			this.tuneAnchorPosition = value;
		}
	}
	,__class__: Metronome
};
...
pixi_plugins_NapeHelpers.createBox = function(type,x,y,w,h) {
	...
	var pivot = ((function($this) {
		...
		if(b.zpp_inner.wrap_localCOM == null) {
			...
			b.zpp_inner.wrap_localCOM.zpp_inner._immutable = true;
			b.zpp_inner.wrap_localCOM.zpp_inner._validate = ($_=b.zpp_inner,$bind($_,$_.getlocalCOM));
		}
		$r = b.zpp_inner.wrap_localCOM;
		return $r;
	}(this))).mul(-1);
	b.translateShapes(pivot);
	((function($this) {
		var $r;
		if(b.zpp_inner_i.userData == null) b.zpp_inner_i.userData = { };
		$r = b.zpp_inner_i.userData;
		return $r;
	}(this))).graphicOffset = pivot;
	((function($this) {
		var $r;
...
Metronome.sensorCbType = new nape_callbacks_CbType();
Metronome.barCbType = new nape_callbacks_CbType();
